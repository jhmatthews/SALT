...
\begin{document}
	...
	\ReferencePair
	    {Groot, et al. J.\ 2004, A\&A 417, 283}
	    {}
	\ReferencePair
	...
	\AdditionalFigures{
	    ...
	    \includegraphics[height=200px]{salt_spectrum_rwtri_v_model.png}

	    \smallskip
	    {\bf Figure 2:} {\sl Top Panel:} In and out of eclipse spectra of the high
		inclination Nova-like RW Tri, which has been digitized from Groot et al. (2004). {\sl Bottom Panel:} In and out of eclipse synthetic
		spectra from Model B. Prominent lines are marked, and the region blueward of the Balmer
		edge is shaded in grey.
